...
//MARK: PhonePickModuleView Class
final class PhonePickViewController: ViewController {
...
extension PhonePickViewController: PhonePickViewControllerApi {
  func setSelectionAt(_ indexPath: IndexPath, selected: Bool) {
    countriesTableView.scrollToRow(at: indexPath, at: .middle, animated: false)
    countriesTableView.selectRow(at: indexPath, animated: false, scrollPosition: .middle)
  }
...
extension PhonePickViewController: KeyboardNotificationsDelegateProtocol {
...
// MARK: - PhonePickModuleView Viper Components API
fileprivate extension PhonePickViewController {
    var presenter: PhonePickPresenterApi {
        return _presenter as! PhonePickPresenterApi
    }
}

extension PhonePickViewController: UITableViewDelegate, UITableViewDataSource {
...
extension PhonePickViewController {
