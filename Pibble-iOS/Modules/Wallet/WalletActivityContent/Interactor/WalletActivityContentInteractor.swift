//
//  WalletActivityContentInteractor.swift
//  Pibble-iOS
//
...
// MARK: - WalletActivityContentInteractor Class
final class WalletActivityContentInteractor: Interactor {
  ...
  fileprivate var fetchResultsController: NSFetchedResultsController<WalletActivityManagedObject>? = nil
...
extension WalletActivityContentInteractor: WalletActivityContentInteractorApi {
...
private extension WalletActivityContentInteractor {
...
extension WalletActivityContentInteractor {
...
//        let invoiceWithRelation = WalletActivitiesRelations.userActivity(activity: activity, user: currentAccount)
  ...
  fileprivate func performFetchFor(account: UserProtocol) {
    ...
    case .walletActivities(_):
      fetchResultsController = setupFRCForWalletActivities(account: account,
                                                           predicate: predicate,
                                                           sortDescriptors: sortDesriptors(),
                                                           delegate: fetchedResultsControllerDelegateProxy)
    case .donationsForPost(_):
      fetchResultsController = setupFRCForDonateTransactions(account: account,
                                                             predicate: predicate,
                                                             sortDescriptors: sortDesriptors(),
                                                             delegate: fetchedResultsControllerDelegateProxy)
    }
  ...
  fileprivate func setupFRCFor<T: WalletActivityManagedObject>(type: T.Type, account: UserProtocol, predicate: NSPredicate?, sortDescriptors: [NSSortDescriptor], delegate: FetchedResultsControllerDelegateProxy) -> NSFetchedResultsController<WalletActivityManagedObject> {
    
    let fetchRequest: NSFetchRequest<WalletActivityManagedObject> = type.fetchRequest()
  ...
  fileprivate func setupFRCForWalletActivities(account: UserProtocol, predicate: NSPredicate?, sortDescriptors: [NSSortDescriptor], delegate: FetchedResultsControllerDelegateProxy) -> NSFetchedResultsController<WalletActivityManagedObject> {
  ...
  fileprivate func setupFRCForDonateTransactions(account: UserProtocol, predicate: NSPredicate?, sortDescriptors: [NSSortDescriptor], delegate: FetchedResultsControllerDelegateProxy) -> NSFetchedResultsController<WalletActivityManagedObject> {
    
    let fetchRequest: NSFetchRequest<WalletActivityManagedObject> = BaseFundingDonateTransactionManagedObject.fetchRequest()
    fetchRequest.predicate = predicate
    fetchRequest.sortDescriptors = sortDescriptors
    fetchRequest.fetchBatchSize = 30
...
extension WalletActivityContentInteractor: PaginationControllerDelegate {
...
extension WalletActivityContentInteractor: FetchedResultsControllerDelegate {
