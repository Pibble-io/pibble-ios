...
class DonateSliderInputView: NibLoadingView {
  //MARK:- IBOutlets
  ...
  weak var delegate: DonateSliderInputViewDelegateProtocol?
  ...
  func setViewModel(_ vm: Donate.UpVoteViewModel, animated: Bool) {
    ...
    slider.thumbTintColor = vm.currentUpVoteCurrencyColor
    slider.tintColor = vm.currentUpVoteCurrencyColor
...
extension DonateSliderInputView {
