...
class ChatDigitalGoodPostHeaderDescriptionTableViewCell: UITableViewCell, DequeueableCell {
  ...
  fileprivate var viewModel: ChatDigitalGoodPostHeaderDescriptionViewModelProtocol? {
    didSet {
...
//      collectionViewHeightConstraint.constant = bounds.size.height
  ...
  func setViewModel(_ vm: ChatDigitalGoodPostHeaderDescriptionViewModelProtocol, handler: @escaping Chat.HeaderDescriptionActionHandler) {
...
extension ChatDigitalGoodPostHeaderDescriptionTableViewCell: UICollectionViewDelegate, UICollectionViewDataSource, UICollectionViewDelegateFlowLayout {
