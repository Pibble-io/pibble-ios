...
typealias UsersListingItemActionsHandler = (UsersListingItemTableViewCell, UsersListing.ItemActions) -> Void

class UsersListingItemTableViewCell: SwipeTableViewCell, DequeueableCell {
  ...
  fileprivate var handler: UsersListingItemActionsHandler?
  
  func setViewModel(_ vm: UserListingItemViewModelProtocol, handler: @escaping UsersListingItemActionsHandler) {
