//
//  PromotionInsightsModuleScope.swift
//  Pibble-iOS
//
...
enum PromotionInsights {
  ...
  fileprivate static func toStringWithFormatter(_ number: Int) -> String {
    ...
    return PromotionInsights.numberToStringsFormatter.string(from: number) ?? ""
  }
  ...
  struct PostEngagementChartContainerViewModel: PromotionPostStatsChartContainerViewModelProtocol {
    let title: String
    let value: String
    ...
    init(promotionStats: PromotionStatisticsProtocol) {
      ...
      let engagements = promotionStats.engagements
  ...
  struct PostImpressionsChartContainerViewModel: PromotionPostStatsChartContainerViewModelProtocol {
    ...
    init(promotionStats: PromotionStatisticsProtocol) {
      ...
      value = "\(sumValue)"
      barsViewModels = impressions
        .sorted { return $0.impressionsDate < $1.impressionsDate }
        .enumerated()
